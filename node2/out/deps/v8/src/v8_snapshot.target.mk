...
quiet_cmd__Users_ramy_Development_projects_Module_3_Project_node_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION _Users_ramy_Development_projects_Module_3_Project_node_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot $@
cmd__Users_ramy_Development_projects_Module_3_Project_node_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8/src; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot" --startup_src "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc" ""
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: export SDKROOT := /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: export SRCROOT := ${abs_srcdir}/deps/v8/src
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: export XCODE_VERSION_ACTUAL := 0910
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: TOOLSET := $(TOOLSET)
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,_Users_ramy_Development_projects_Module_3_Project_node_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
action__Users_ramy_Development_projects_Module_3_Project_node_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
...
$(OBJS): | $(action__Users_ramy_Development_projects_Module_3_Project_node_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(builddir)/libv8_snapshot.a: | $(action__Users_ramy_Development_projects_Module_3_Project_node_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__Users_ramy_Development_projects_Module_3_Project_node_deps_v8_src_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(builddir)/mksnapshot $(obj).target/deps/v8/src/js2c.stamp
